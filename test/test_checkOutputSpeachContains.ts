...
import { checkOutputSpeachContains } from "../src";

describe("checkOutputSpeachContains", () => {
  it("should be a function", () => {
    expect(checkOutputSpeachContains).to.be.an.instanceOf(Function);
  });
  ...
  it("should fail when response is missing", () => {
    ...
    let err;
    try {
      checkOutputSpeachContains(skillResponse as ResponseEnvelope, "blah");
    } catch (e) {
      err = e;
    }
